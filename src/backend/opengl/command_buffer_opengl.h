...
void
scegfx_command_buffer_opengl_copy_buffer(scegfx_command_buffer_t* this,
                                         const scegfx_buffer_t* src_buffer,
                                         const scegfx_buffer_t* dst_buffer,
                                         const scegfx_buffer_copy_t* region);
void
scegfx_command_buffer_opengl_copy_image(scegfx_command_buffer_t* this,
...
void
scegfx_command_buffer_opengl_blit_image(scegfx_command_buffer_t* this,
                                        const scegfx_image_t* src_image,
                                        scegfx_image_layout_t src_image_layout,
                                        const scegfx_image_t* dst_image,
                                        scegfx_image_layout_t dst_image_layout,
...
const static scegfx_command_buffer_api_vtable_t
  scegfx_command_buffer_api_vtable_opengl = {
    ...
    .bind_descriptor_set = scegfx_command_buffer_opengl_bind_descriptor_set,
    ...
    .copy_buffer = scegfx_command_buffer_opengl_copy_buffer,
    .copy_image = scegfx_command_buffer_opengl_copy_image,
    .blit_image = scegfx_command_buffer_opengl_blit_image,
    .copy_buffer_to_image = scegfx_command_buffer_opengl_copy_buffer_to_image,
    .copy_image_to_buffer = scegfx_command_buffer_opengl_copy_image_to_buffer,
    .pipeline_barrier = scegfx_command_buffer_opengl_pipeline_barrier,
