...
#ifndef SCEGFX_SWAPCHAIN_GLES_H
#define SCEGFX_SWAPCHAIN_GLES_H
...
const static scegfx_swapchain_api_vtable_t scegfx_swapchain_api_vtable_gles = {
  .initialize = scegfx_swapchain_opengl_initialize,
  .terminate = scegfx_swapchain_opengl_terminate,
};

#endif // SCEGFX_SWAPCHAIN_GLES_H
